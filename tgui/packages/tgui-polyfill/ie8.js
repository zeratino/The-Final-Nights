...
(function (window) {
  ...
  defineProperties(ElementPrototype, {
    ...
    addEventListener: valueDesc(function (type, handler, capture) {
      ...
      var self = this,
        ontype = 'on' + type,
        temple =
          self[SECRET] || defineProperty(self, SECRET, { value: {} })[SECRET],
      ...
      if (!hasOwnProperty.call(currentType, 'w')) {
        currentType.w = function (e) {
          ...
          return (
            e[SECRET] || commonEventLoop(self, verify(self, e), handlers, false)
          );
        };
        // if not detected yet
  ...
  defineProperties(window.Event.prototype, {
    ...
    pageX: {
      get: function () {
        return (
          this._pageX ||
          (this._pageX = this.clientX + window.scrollX - (html.clientLeft || 0))
        );
      },
    },
    pageY: {
      get: function () {
        return (
          this._pageY ||
          (this._pageY = this.clientY + window.scrollY - (html.clientTop || 0))
        );
      },
    },
    which: {
  ...
  defineProperties(window.HTMLDocument.prototype, {
    ...
    addEventListener: valueDesc(function (type, handler, capture) {
      ...
      if (
        ...
        !readyStateOK.test(self.readyState)
      ) {
  ...
  defineProperties(window.Window.prototype, {
    ...
    addEventListener: valueDesc(function (type, handler, capture) {
      ...
      if (!self[ontype]) {
        self[ontype] = function (e) {
          return (
            commonEventLoop(self, verify(self, e), handlers, false) && undefined
          );
        };
      }
    ...
    dispatchEvent: valueDesc(function (e) {
      ...
      return method
        ? method.call(window, e) !== false && !e.defaultPrevented
        : true;
    }),
    removeEventListener: valueDesc(function (type, handler, capture) {
      var ontype = 'on' + type,
  ...
  (function () {
    ...
    proto.cloneContents = function cloneContents() {
      for (
        var fragment = this._start.ownerDocument.createDocumentFragment(),
