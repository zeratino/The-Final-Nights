...
export const CivCargoHoldTerminal = (props, context) => {
  ...
  return (
    <Window resizable width={500} height={375}>
    ...
    <Section title="Please Select a Bounty:" textAlign="center">
      <Flex width="100%" wrap>
        <Flex.Item shrink={0} grow={0.5}>
          ...
          >
            <Box fontSize="14px">Payout: {id_bounty_values[0]}</Box>
          </Button>
        </Flex.Item>
        <Flex.Item shrink={0} grow={0.5} px={1}>
          ...
          >
            <Box fontSize="14px">Payout: {id_bounty_values[1]}</Box>
          </Button>
        </Flex.Item>
        <Flex.Item shrink={0} grow={0.5}>
          <Button
          ...
          >
            <Box fontSize="14px">Payout: {id_bounty_values[2]}</Box>
          </Button>
        </Flex.Item>
      </Flex>
    </Section>
