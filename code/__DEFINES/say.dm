...
#define FOLLOW_LINK(alice, bob) "<a href=byond://?[REF(alice)];follow=[REF(bob)]>(F)</a>" //<a href=byond://?[REF(alice)];follow=[REF(bob)]>(F)</a> //! [ChillRaccoon] - REWORK OR REMOVE
#define TURF_LINK(alice, turfy) "<a href=byond://?[REF(alice)];x=[turfy.x];y=[turfy.y];z=[turfy.z]>(T)</a>" //<a href=byond://?[REF(alice)];x=[turfy.x];y=[turfy.y];z=[turfy.z]>(T)</a> //! [ChillRaccoon] - REWORK OR REMOVE
#define FOLLOW_OR_TURF_LINK(alice, bob, turfy) "<a href=byond://?[REF(alice)];follow=[REF(bob)];x=[turfy.x];y=[turfy.y];z=[turfy.z]>(F)</a>" //<a href=byond://?[REF(alice)];follow=[REF(bob)];x=[turfy.x];y=[turfy.y];z=[turfy.z]>(F)</a> //! [ChillRaccoon] - REWORK OR REMOVE
