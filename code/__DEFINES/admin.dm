...
#define ADMIN_AM(user) "(<a href='byond://?_src_=holder;[HrefToken(TRUE)];adjustmasquerade=[REF(user)]'>AM</a>)"
#define ADMIN_AH(user) "(<a href='byond://?_src_=holder;[HrefToken(TRUE)];adjusthumanity=[REF(user)]'>AH</a>)"
