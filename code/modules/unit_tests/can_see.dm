...
/datum/unit_test/can_see_test/Run()
	var/mob/living/carbon/human/observer = allocate(/mob/living/carbon/human, run_loc_floor_bottom_left) //make sure they're both apart
	var/mob/living/carbon/human/to_be_seen = allocate(/mob/living/carbon/human, run_loc_floor_top_right)
