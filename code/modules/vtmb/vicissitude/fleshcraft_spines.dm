/datum/surgery/fleshcraft_spines
	name = "Fleshcraft Spines"
	steps = list(/datum/surgery_step/incise,
				/datum/surgery_step/clamp_bleeders,
				/datum/surgery_step/retract_skin,
				/datum/surgery_step/incise,
				/datum/surgery_step/craft_spines,
				/datum/surgery_step/close)

	possible_locs = list(BODY_ZONE_CHEST)
	self_operable = TRUE

/datum/surgery/fleshcraft_spines/can_start(mob/user, mob/living/carbon/target)
	if(!ishuman(target))
		return FALSE
	if(!iskindred(user))
		return FALSE
...
/datum/surgery_step/craft_spines/preop(mob/user, mob/living/carbon/target, target_zone, obj/item/tool, datum/surgery/surgery)
...
/datum/surgery_step/craft_spines/success(mob/user, mob/living/target, target_zone, obj/item/tool, datum/surgery/surgery, default_display_results = FALSE)
	...
	var/mutable_appearance/spinesoverlay = mutable_appearance('code/modules/wod13/icons.dmi', "spines", -UNICORN_LAYER)
	victim.overlays_standing[UNICORN_LAYER] = spinesoverlay
