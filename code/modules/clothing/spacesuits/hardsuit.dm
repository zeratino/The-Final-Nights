...
/obj/item/clothing/suit/space/hardsuit
	...
	allowed = list(/obj/item/flashlight, /obj/item/internals, /obj/item/t_scanner, /obj/item/construction/rcd, /obj/item/pipe_dispenser)
...
/obj/item/clothing/head/helmet/space/hardsuit/mining
	...
	light_range = 7
	allowed = list(/obj/item/flashlight, /obj/item/internals, /obj/item/resonator, /obj/item/mining_scanner, /obj/item/t_scanner/adv_mining_scanner, /obj/item/gun/energy/kinetic_accelerator)
...
/obj/item/clothing/suit/space/hardsuit/mining
	...
	resistance_flags = FIRE_PROOF
	armor = list(MELEE = 30, BULLET = 5, LASER = 10, ENERGY = 20, BOMB = 50, BIO = 100, RAD = 50, FIRE = 50, ACID = 75, WOUND = 15)
	allowed = list(/obj/item/flashlight, /obj/item/internals, /obj/item/storage/bag/ore, /obj/item/pickaxe)
...
/obj/item/clothing/suit/space/hardsuit/syndi
	...
	armor = list(MELEE = 40, BULLET = 50, LASER = 30, ENERGY = 40, BOMB = 35, BIO = 100, RAD = 50, FIRE = 50, ACID = 90, WOUND = 25)
	allowed = list(/obj/item/gun, /obj/item/ammo_box,/obj/item/ammo_casing, /obj/item/melee/baton, /obj/item/melee/transforming/energy/sword/saber, /obj/item/restraints/handcuffs, /obj/item/internals)
...
/obj/item/clothing/suit/space/hardsuit/wizard
	...
	resistance_flags = FIRE_PROOF | ACID_PROOF
	armor = list(MELEE = 40, BULLET = 40, LASER = 40, ENERGY = 50, BOMB = 35, BIO = 100, RAD = 50, FIRE = 100, ACID = 100, WOUND = 30)
	allowed = list(/obj/item/teleportation_scroll, /obj/item/internals)
	heat_protection = CHEST|GROIN|LEGS|FEET|ARMS|HANDS					//Uncomment to enable firesuit protection
	max_heat_protection_temperature = FIRE_IMMUNITY_MAX_TEMP_PROTECT
...
/obj/item/clothing/suit/space/hardsuit/medical
	...
	allowed = list(/obj/item/flashlight, /obj/item/internals, /obj/item/storage/firstaid, /obj/item/healthanalyzer, /obj/item/stack/medical)
	armor = list(MELEE = 30, BULLET = 5, LASER = 10, ENERGY = 20, BOMB = 10, BIO = 100, RAD = 60, FIRE = 60, ACID = 75, WOUND = 10)
...
/obj/item/clothing/suit/space/hardsuit/rd
	...
	allowed = list(/obj/item/flashlight, /obj/item/internals, /obj/item/gun/energy/wormhole_projector,
...
/obj/item/clothing/suit/space/hardsuit/shielded/syndi/Initialize()
	jetpack = new /obj/item/jetpack/suit(src)
	. = ..()
