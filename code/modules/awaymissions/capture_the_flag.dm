...
/obj/machinery/capture_the_flag/proc/start_ctf()
	...
	notify_ghosts("[name] has been activated!", enter_link="<a href=byond://?[REF(src)];join=1>(Click to join the [team] team!)</a> or click on the controller directly!", source = src, action=NOTIFY_ATTACK, header = "CTF has been activated")
