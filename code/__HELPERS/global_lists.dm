...
GLOBAL_LIST_EMPTY(clans_list)	//>:3
...
/proc/make_datum_references_lists()
	...
	for(var/spath in subtypesof(/datum/vampireclan))
		var/datum/vampireclan/S = new spath()
		GLOB.clans_list[S.name] = spath
	sortList(GLOB.clans_list, GLOBAL_PROC_REF(cmp_typepaths_asc))
