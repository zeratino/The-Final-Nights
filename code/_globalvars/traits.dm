...
GLOBAL_LIST_INIT(traits_by_type, list(
	/mob = list(
		...
		"TRAIT_FLASH_SENSITIVE" = TRAIT_FLASH_SENSITIVE,
		...
		"TRAIT_DUFFEL_CURSED" = TRAIT_DUFFEL_CURSED,
		...
		"TRAIT_GUNFIGHTER" = TRAIT_GUNFIGHTER,
		"TRAIT_SUPERMATTER_MADNESS_IMMUNE" = TRAIT_SUPERMATTER_MADNESS_IMMUNE,
		"TRAIT_SUPERMATTER_SOOTHER" = TRAIT_SUPERMATTER_SOOTHER,
		"TRAIT_DONUT_LOVER" = TRAIT_DONUT_LOVER,
		...
		"TRAIT_SNOB" = TRAIT_SNOB,
		"TRAIT_BALD" = TRAIT_BALD,
		"TRAIT_THUNDERSHOT" = TRAIT_THUNDERSHOT,
		"TRAIT_EXP_DRIVER" = TRAIT_EXP_DRIVER,
		"TRAIT_BONE_KEY" = TRAIT_BONE_KEY,
		"TRAIT_BLOODY_LOVER" = TRAIT_BLOODY_LOVER,
		"TRAIT_TOUGH_FLESH" = TRAIT_TOUGH_FLESH,
		"TRAIT_BLOODY_SUCKER" = TRAIT_BLOODY_SUCKER,
		"TRAIT_NON_INT" = TRAIT_NON_INT,
		"TRAIT_COFFIN_THERAPY" = TRAIT_COFFIN_THERAPY,
		"TRAIT_RUBICON" = TRAIT_RUBICON,
		"TRAIT_HUNGRY" = TRAIT_HUNGRY,
		"TRAIT_STAKE_RESISTANT" = TRAIT_STAKE_RESISTANT,
		"TRAIT_COLD_AURA" = TRAIT_COLD_AURA,
		"TRAIT_WARM_AURA" = TRAIT_WARM_AURA,
		"TRAIT_BLUSH_OF_HEALTH" = TRAIT_BLUSH_OF_HEALTH,
		"TRAIT_POTENT_BLOOD" = TRAIT_POTENT_BLOOD,
		"TRAIT_CAN_EAT" = TRAIT_CAN_EAT,
		"TRAIT_MESSY_EATER" = TRAIT_MESSY_EATER,
		"TRAIT_DEBTOR" = TRAIT_DEBTOR,
		"TRAIT_ANIMAL_REPULSION" = TRAIT_ANIMAL_REPULSION,
		"TRAIT_ILLEGAL_IDENTITY" = TRAIT_ILLEGAL_IDENTITY,
		"TRAIT_LAZY" = TRAIT_LAZY,
		"TRAIT_HOMOSEXUAL" = TRAIT_HOMOSEXUAL,
		"TRAIT_HUNTED" = TRAIT_HUNTED,
		"TRAIT_VIOLATOR" = TRAIT_VIOLATOR,
		"TRAIT_DIABLERIE" = TRAIT_DIABLERIE,
		"TRAIT_GULLET" = TRAIT_GULLET,
		"TRAIT_CHARMER" = TRAIT_CHARMER,
		"TRAIT_UNMASQUERADE" = TRAIT_UNMASQUERADE,
		"TRAIT_NONMASQUERADE" = TRAIT_NONMASQUERADE,
		"TRAIT_DANCER" = TRAIT_DANCER,
		"TRAIT_SUPERNATURAL_LUCK" = TRAIT_SUPERNATURAL_LUCK,
		"TRAIT_HANDS_BLOCK_PROJECTILES" = TRAIT_HANDS_BLOCK_PROJECTILES,
		"TRAIT_ENHANCED_MELEE_DODGE" = TRAIT_ENHANCED_MELEE_DODGE,
		"TRAIT_SUPERNATURAL_DEXTERITY" = TRAIT_SUPERNATURAL_DEXTERITY,
		"TRAIT_PASS_THROUGH_WALLS" = TRAIT_PASS_THROUGH_WALLS,
		"TRAIT_UNDENSE" = TRAIT_UNDENSE,
		"TRAIT_LEANING" = TRAIT_LEANING,
		"TRAIT_OBFUSCATED" = TRAIT_OBFUSCATED
	),
