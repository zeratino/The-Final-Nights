...
/datum/browser/modal/alert/New(User,Message,Title,Button1="Ok",Button2,Button3,StealFocus = 1,Timeout=6000)
	...
	var/output =  {"<center><b>[Message]</b></center><br />
		...
		<a style="font-size:large;float:[( Button2 ? "left" : "right" )]" href="byond://?[REF(src)];button=1">[Button1]</a>"}

	if (Button2)
		output += {"<a style="font-size:large;[( Button3 ? "" : "float:right" )]" href="byond://?[REF(src)];button=2">[Button2]</a>"}

	if (Button3)
		output += {"<a style="font-size:large;float:right" href="byond://?[REF(src)];button=3">[Button3]</a>"}
